...
public class Ex2 implements Runnable {
     ...
     * using the most ratio by value of pokemon / shortest path.
    ...
    private static int goToPokemon(CL_Pokemon poke, directed_weighted_graph gg, int counter, CL_Agent ag) {
        ...
        else if (ag.getSpeed() > 4.2 && longWay.size() <=2){dt=50;}
     ...
     * by doing a very random walk on the node edges and chose 1 edge to go.
     *
     * @param g
     * @param src
     * @return random edge
